...
async function prepareBundle() {
  ...
  console.log('Patching context window to support longer models...');
  await runCommand('bun', ['run', 'scripts/build/patch-context-window.js']);
}
...
async function prepareWindowsBundle() {
  ...
  console.log('Patching context window for Windows bundle...');
  await runCommand('bun', ['run', 'scripts/build/patch-context-window.js']);
}
